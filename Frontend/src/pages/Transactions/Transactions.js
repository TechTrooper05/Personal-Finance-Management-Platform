...
function Transactions({transactions, setTransactions, showForm, setShowForm}) {
    ...
    return (
        ...
        <div className="transaction-page-container">
            ...
            <TransactionList key={transaction._id} transaction={transaction} transactions={transactions} setTransactions={setTransactions} isdelete={isdelete} setIsdelete={setIsdelete}/>
            ))}
        </div>
        </>
    );
